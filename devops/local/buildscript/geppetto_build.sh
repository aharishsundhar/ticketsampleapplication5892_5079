...
APPLICATION='/ticketsampleapplication5892'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication5892-desktop:1.0'
...
helm install --name ticketsampleapplication5892-5079 ./helm
if [ $? -eq 0 ]; then
